                        ...
                        <span
                            ...
                            <svg
                                ...
                                <path
                                    ...
                                    d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 \
                                    9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 \
                                    0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.\
                                    75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z"/>
                            </svg>
                        </span>
                        <span>Link 1</span>
                    </a>
                        ...
                        <span class="mr-4 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:text-gray-400 dark:[&>svg]:text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 \
                                    ...
                                    10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z"
                                    clip-rule="evenodd" />
                            </svg>
                        </span>
